...
_BASE_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_LIST_ITEMTYPE_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_UNION_MEMBERTYPE_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_ELEMENTCONTAINER_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_MAXOCCURS_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_ELEMENT_TYPE_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_FORM_TYPE = _descriptor.EnumDescriptor(
  name='Type',
...
_ATTRIBUTE_TYPE_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_ATTRIBUTE_USE = _descriptor.EnumDescriptor(
  name='Use',
...
_BUILTIN_TYPE = _descriptor.EnumDescriptor(
  name='Type',
...
_SCHEMA_NAMESPACE = _descriptor.Descriptor(
  name='Namespace',
...
_SIMPLETYPE_TYPE = _descriptor.Descriptor(
  name='Type',
...
_LIST_ITEMTYPE = _descriptor.Descriptor(
  name='ItemType',
...
_UNION_MEMBERTYPE = _descriptor.Descriptor(
  name='MemberType',
...
_ELEMENTCONTAINER = _descriptor.Descriptor(
...
_MAXOCCURS = _descriptor.Descriptor(
  name='MaxOccurs',
...
_ELEMENT_TYPE = _descriptor.Descriptor(
  name='Type',
...
_ATTRIBUTE_TYPE = _descriptor.Descriptor(
  name='Type',
...
_ANYATTRIBUTE = _descriptor.Descriptor(
  name='AnyAttribute',
...
class SimpleType(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class Union(_message.Message):
  ...
  class MemberType(_message.Message):
    __metaclass__ = _reflection.GeneratedProtocolMessageType
...
class AnyAttribute(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
