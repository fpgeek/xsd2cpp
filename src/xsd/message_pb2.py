...
_MESSAGE_KIND = _descriptor.EnumDescriptor(
  name='Kind',
...
_CHOICEMESSAGE_TYPE = _descriptor.EnumDescriptor(
  name='Type',
...
_SEQUENCEMESSAGE_TYPE = _descriptor.EnumDescriptor(
  name='Type',
...
_CHOICEMESSAGE = _descriptor.Descriptor(
  name='ChoiceMessage',
...
class ChoiceMessage(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
