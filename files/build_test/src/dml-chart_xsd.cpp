    ...
    CT_PlotArea::~CT_PlotArea()
{
    ...
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_areaChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_area3DChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_lineChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_line3DChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_stockChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_radarChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_scatterChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_pieChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_pie3DChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_doughnutChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_barChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_bar3DChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_ofPieChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_surfaceChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_surface3DChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_bubbleChart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_valAx));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_catAx));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_dateAx));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_serAx));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
