    ...
    CT_Drawing::~CT_Drawing()
{
    ...
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_twoCellAnchor));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_oneCellAnchor));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_absoluteAnchor));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
