    ...
    CT_WordprocessingGroup::~CT_WordprocessingGroup()
{
    ...
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_wsp));
    ...
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_dpct_pic));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_contentPart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    ...
    CT_WordprocessingCanvas::~CT_WordprocessingCanvas()
{
    ...
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_wgp));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
