    ...
    CT_R::~CT_R()
{
    ...
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_br));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_t));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_contentPart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_delText));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_instrText));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_delInstrText));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_noBreakHyphen));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_softHyphen));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_dayShort));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_monthShort));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_yearShort));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_dayLong));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_monthLong));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_yearLong));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_annotationRef));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_footnoteRef));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_endnoteRef));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_separator));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_continuationSeparator));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_sym));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_pgNum));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_cr));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_tab));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_object));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_pict));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_fldChar));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_ruby));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_footnoteReference));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_endnoteReference));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_commentReference));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_drawing));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_ptab));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_w_lastRenderedPageBreak));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_t));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    ...
    CT_OMathArg::~CT_OMathArg()
{
    ...
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_acc));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_bar));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_box));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_borderBox));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_d));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_eqArr));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_f));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_func));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_groupChr));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_limLow));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_limUpp));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_m));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_nary));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_phant));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_rad));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_sPre));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_sSub));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_sSubSup));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_sSup));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_1.begin(), m_childGroupList_1.end(), mem_fun(&ChildGroup_1::has_r));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    ...
    {
        int elemCnt = count_if(m_childGroupList_2.begin(), m_childGroupList_2.end(), mem_fun(&ChildGroup_2::has_w_customXml));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_2.begin(), m_childGroupList_2.end(), mem_fun(&ChildGroup_2::has_w_hyperlink));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    ...
    {
        int elemCnt = count_if(m_childGroupList_3.begin(), m_childGroupList_3.end(), mem_fun(&ChildGroup_3::has_w_smartTag));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_3.begin(), m_childGroupList_3.end(), mem_fun(&ChildGroup_3::has_w_sdt));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    ...
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_bookmarkStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_bookmarkEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_moveFromRangeStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_moveFromRangeEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_moveToRangeStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_moveToRangeEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_commentRangeStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_commentRangeEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlInsRangeStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlInsRangeEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlDelRangeStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlDelRangeEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlMoveFromRangeStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlMoveFromRangeEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlMoveToRangeStart));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_customXmlMoveToRangeEnd));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_ins));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_del));
        assert(0 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_moveFrom));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_5.begin(), m_childGroupList_5.end(), mem_fun(&ChildGroup_5::has_w_moveTo));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    ...
    {
        int elemCnt = count_if(m_childGroupList_6.begin(), m_childGroupList_6.end(), mem_fun(&ChildGroup_6::has_m_oMathPara));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    
    
    {
        int elemCnt = count_if(m_childGroupList_6.begin(), m_childGroupList_6.end(), mem_fun(&ChildGroup_6::has_m_oMath));
        assert(1 <= elemCnt && elemCnt <= 1);
    }
    ...
    bool CT_OMathArg::ChildGroup_5::has_w_ins() const
    {    
    return m_has_w_ins;
    }

    ns_w::CT_RunTrackChange* CT_OMathArg::ChildGroup_5::mutable_w_ins()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMathArg::ChildGroup_5::get_w_ins() const
    {    
    if (m_w_ins)
    {
        return *m_w_ins;
    ...
    bool CT_OMathArg::ChildGroup_5::has_w_del() const
    {    
    return m_has_w_del;
    }

    ns_w::CT_RunTrackChange* CT_OMathArg::ChildGroup_5::mutable_w_del()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMathArg::ChildGroup_5::get_w_del() const
    {    
    if (m_w_del)
    {
        return *m_w_del;
    ...
    bool CT_OMathArg::ChildGroup_5::has_w_moveFrom() const
    {    
    return m_has_w_moveFrom;
    }

    ns_w::CT_RunTrackChange* CT_OMathArg::ChildGroup_5::mutable_w_moveFrom()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMathArg::ChildGroup_5::get_w_moveFrom() const
    {    
    if (m_w_moveFrom)
    {
        return *m_w_moveFrom;
    ...
    bool CT_OMathArg::ChildGroup_5::has_w_moveTo() const
    {    
    return m_has_w_moveTo;
    }

    ns_w::CT_RunTrackChange* CT_OMathArg::ChildGroup_5::mutable_w_moveTo()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMathArg::ChildGroup_5::get_w_moveTo() const
    {    
    if (m_w_moveTo)
    {
        return *m_w_moveTo;
    ...
    bool CT_OMathArg::ChildGroup_6::has_m_oMathPara() const
    {    
    return m_has_m_oMathPara;
    }

    ns_m::CT_OMathPara* CT_OMathArg::ChildGroup_6::mutable_m_oMathPara()
    {    
    ...
    const ns_m::CT_OMathPara& CT_OMathArg::ChildGroup_6::get_m_oMathPara() const
    {    
    if (m_m_oMathPara)
    {
        return *m_m_oMathPara;
    ...
    bool CT_OMathArg::ChildGroup_6::has_m_oMath() const
    {    
    return m_has_m_oMath;
    }

    ns_m::CT_OMath* CT_OMathArg::ChildGroup_6::mutable_m_oMath()
    {    
    ...
    const ns_m::CT_OMath& CT_OMathArg::ChildGroup_6::get_m_oMath() const
    {    
    if (m_m_oMath)
    {
        return *m_m_oMath;
    ...
    CT_OMath::~CT_OMath()
{
    ...
    bool CT_OMath::ChildGroup_5::has_w_ins() const
    {    
    return m_has_w_ins;
    }

    ns_w::CT_RunTrackChange* CT_OMath::ChildGroup_5::mutable_w_ins()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMath::ChildGroup_5::get_w_ins() const
    {    
    if (m_w_ins)
    {
        return *m_w_ins;
    ...
    bool CT_OMath::ChildGroup_5::has_w_del() const
    {    
    return m_has_w_del;
    }

    ns_w::CT_RunTrackChange* CT_OMath::ChildGroup_5::mutable_w_del()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMath::ChildGroup_5::get_w_del() const
    {    
    if (m_w_del)
    {
        return *m_w_del;
    ...
    bool CT_OMath::ChildGroup_5::has_w_moveFrom() const
    {    
    return m_has_w_moveFrom;
    }

    ns_w::CT_RunTrackChange* CT_OMath::ChildGroup_5::mutable_w_moveFrom()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMath::ChildGroup_5::get_w_moveFrom() const
    {    
    if (m_w_moveFrom)
    {
        return *m_w_moveFrom;
    ...
    bool CT_OMath::ChildGroup_5::has_w_moveTo() const
    {    
    return m_has_w_moveTo;
    }

    ns_w::CT_RunTrackChange* CT_OMath::ChildGroup_5::mutable_w_moveTo()
    {    
    ...
    const ns_w::CT_RunTrackChange& CT_OMath::ChildGroup_5::get_w_moveTo() const
    {    
    if (m_w_moveTo)
    {
        return *m_w_moveTo;
    ...
    bool CT_OMath::ChildGroup_6::has_m_oMathPara() const
    {    
    return m_has_m_oMathPara;
    }

    ns_m::CT_OMathPara* CT_OMath::ChildGroup_6::mutable_m_oMathPara()
    {    
    ...
    const ns_m::CT_OMathPara& CT_OMath::ChildGroup_6::get_m_oMathPara() const
    {    
    if (m_m_oMathPara)
    {
        return *m_m_oMathPara;
    ...
    bool CT_OMath::ChildGroup_6::has_m_oMath() const
    {    
    return m_has_m_oMath;
    }

    ns_m::CT_OMath* CT_OMath::ChildGroup_6::mutable_m_oMath()
    {    
    ...
    const ns_m::CT_OMath& CT_OMath::ChildGroup_6::get_m_oMath() const
    {    
    if (m_m_oMath)
    {
        return *m_m_oMath;
    ...
    oMath_element::~oMath_element()
{
    ...
    bool oMath_element::ChildGroup_5::has_w_ins() const
    {    
    return m_has_w_ins;
    }

    ns_w::CT_RunTrackChange* oMath_element::ChildGroup_5::mutable_w_ins()
    {    
    ...
    const ns_w::CT_RunTrackChange& oMath_element::ChildGroup_5::get_w_ins() const
    {    
    if (m_w_ins)
    {
        return *m_w_ins;
    ...
    bool oMath_element::ChildGroup_5::has_w_del() const
    {    
    return m_has_w_del;
    }

    ns_w::CT_RunTrackChange* oMath_element::ChildGroup_5::mutable_w_del()
    {    
    ...
    const ns_w::CT_RunTrackChange& oMath_element::ChildGroup_5::get_w_del() const
    {    
    if (m_w_del)
    {
        return *m_w_del;
    ...
    bool oMath_element::ChildGroup_5::has_w_moveFrom() const
    {    
    return m_has_w_moveFrom;
    }

    ns_w::CT_RunTrackChange* oMath_element::ChildGroup_5::mutable_w_moveFrom()
    {    
    ...
    const ns_w::CT_RunTrackChange& oMath_element::ChildGroup_5::get_w_moveFrom() const
    {    
    if (m_w_moveFrom)
    {
        return *m_w_moveFrom;
    ...
    bool oMath_element::ChildGroup_5::has_w_moveTo() const
    {    
    return m_has_w_moveTo;
    }

    ns_w::CT_RunTrackChange* oMath_element::ChildGroup_5::mutable_w_moveTo()
    {    
    ...
    const ns_w::CT_RunTrackChange& oMath_element::ChildGroup_5::get_w_moveTo() const
    {    
    if (m_w_moveTo)
    {
        return *m_w_moveTo;
    ...
    bool oMath_element::ChildGroup_6::has_m_oMathPara() const
    {    
    return m_has_m_oMathPara;
    }

    ns_m::CT_OMathPara* oMath_element::ChildGroup_6::mutable_m_oMathPara()
    {    
    ...
    const ns_m::CT_OMathPara& oMath_element::ChildGroup_6::get_m_oMathPara() const
    {    
    if (m_m_oMathPara)
    {
        return *m_m_oMathPara;
    ...
    bool oMath_element::ChildGroup_6::has_m_oMath() const
    {    
    return m_has_m_oMath;
    }

    ns_m::CT_OMath* oMath_element::ChildGroup_6::mutable_m_oMath()
    {    
    ...
    const ns_m::CT_OMath& oMath_element::ChildGroup_6::get_m_oMath() const
    {    
    if (m_m_oMath)
    {
        return *m_m_oMath;
